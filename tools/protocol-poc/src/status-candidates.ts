...
export const STATUS_20001_CANDIDATES: readonly StatusCandidate[] = [
  ...
  },
  {
    ...
    unit: "s",
    confidence: "observed",
    note: "Observed as elapsed current/last cleaning time in seconds.",
  },
  {
    ...
    candidateRole: "value",
    confidence: "candidate",
    note: "Likely lifetime or accumulated area; exact meaning and scale pending.",
  },
  {
    ...
    unit: "s",
    confidence: "candidate",
    note: "Likely lifetime or accumulated time in seconds; exact meaning pending.",
  },
  {
    upstreamField: "elec",
    valueType: "number",
  ...
  },
  {
    ...
    candidateRole: "state",
    confidence: "observed",
    note: "Observed values include charge, sweep, pause, and backcharge.",
  },
  {
    ...
    candidateRole: "state",
    confidence: "observed",
    note: "Observed values include total and the literal string null.",
  },
  {
    upstreamField: "water",
    valueType: "number",
