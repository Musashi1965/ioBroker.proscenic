...
export class ProscenicCommandClient {
  ...
  private async postJson<T>(
    ...
    return await this.request<T>(path, JSON.stringify(body), {
  ...
  private async postForm<T>(
    ...
    return await this.postFormPath(path, new URLSearchParams(body).toString(), headers);
  }
